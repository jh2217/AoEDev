...
class CvPediaFeature:
	...
	def __init__(self, main):
		...
		self.FILTERS =	[
			...
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_GRASSLAND", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_GRASS"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_PLAINS", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_PLAINS"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_DESERT", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_DESERT"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_MARSH", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_MARSH"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_TAIGA", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_TAIGA"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_TUNDRA", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_TUNDRA"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_COAST", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_COAST"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_OCEAN", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_OCEAN"))',
				"Desired Result" : 'True',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_HELL", ())',
				"Purpose" : "Filter by valid Terrain type",
				"Hardcoded" : False,
				"HardcodeList" : [],
				"Value to Check" : 'eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_BURNING_SANDS")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_BROKEN_LANDS")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_FIELDS_OF_PERDITION")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_FIELDS_OF_PERDITION")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_SHALLOWS")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_BLACKWATER")) or eFeature.isTerrain(gc.getInfoTypeForString("TERRAIN_BLIGHTED_COAST"))',
				"Desired Result" : 'True',
			},
			]
		...
		self.SORTS =	[
			...
			},
			{
				...
				"Purpose" : "Default Sorting Method",
				"Value to Sort" : '-eFeature.getYieldChange(YieldTypes.YIELD_FOOD)',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_PRODUCTION_BONUS", ())',
				"Purpose" : "Default Sorting Method",
				"Value to Sort" : '-eFeature.getYieldChange(YieldTypes.YIELD_PRODUCTION)',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_COMMERCE", ())',
				"Purpose" : "Default Sorting Method",
				"Value to Sort" : '-eFeature.getYieldChange(YieldTypes.YIELD_COMMERCE)',
			},
			{
				"name" : 'localText.getText("TXT_KEY_PEDIA_FILTER_FEATURE_DEFENSE", ())',
				"Purpose" : "Default Sorting Method",
				"Value to Sort" : '-eFeature.getDefenseModifier()',
			},
			{
...
#				screen.attachTextGFC(panelName, "", szYield + (u"%c" % gc.getYieldInfo(k).getChar()), FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
	...
	def placeSpecial(self):
		...
		# test Ronkhar
		# HelpText = gc.getFeatureInfo(self.iFeature).getHelp()
	...
	def placeHistory(self):
		...
		HistoryText = gc.getFeatureInfo(self.iFeature).getCivilopedia()
	...
	def placeLinks(self, bRedraw):
		...
		for iI in range(len(listSorted)):
			...
			if bRedraw:
				screen.appendListBoxString(self.top.LIST_ID, szName, WidgetTypes.WIDGET_PEDIA_JUMP_TO_FEATURE, iFeature, -1, CvUtil.FONT_LEFT_JUSTIFY)
	...
	def getSortedList(self):
		...
		for iFeature in range(gc.getNumFeatureInfos()):
			eFeature = gc.getFeatureInfo(iFeature)
	...
	def applyFilterSort(self, filter, sort):
		if not self.CURRENT_SORT == sort:
			...
			self.top.pediaJump(CvScreenEnums.PEDIA_MAIN, CivilopediaPageTypes.CIVILOPEDIA_PAGE_FEATURE, True)
