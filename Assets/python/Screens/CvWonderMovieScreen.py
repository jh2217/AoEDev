...
class CvWonderMovieScreen:
	...
	def interfaceScreen (self, iMovieItem, iCityId, iMovieType):
		...
		if self.iMovieType == MOVIE_SCREEN_RELIGION or self.iMovieType == MOVIE_SCREEN_RELIGION_BIK:
	...
	def playMovie(self):
		...
		elif self.iMovieType == MOVIE_SCREEN_RELIGION_BIK:
