...
#FfH: Added by Kael 08/26/2006
#EventSetHasTrait = 5013
#FfH: End Add
## FfH Card Game: begin
EventSelectSolmniumPlayer = 5013
EventSolmniumAcceptGame = 5014
...
SilentEvents = [EventEditCityName, EventEditUnitName, EventSelectSolmniumPlayer, EventSolmniumAcceptGame, EventSolmniumConcedeGame]
...
def convertToStrLatin(s):
	if (isinstance(s, unicode)):
		return s.encode("latin_1")
	return s

def removeAccent(self, text):
		""" Remove accents from text. Enables alphabetical sorting in the Pedia for languages using accents/diacritics """
		accents = { 'A': [u'Â', u'À'],
		            'a': [u'â', u'à'],
		            'E': [u'É'],
		            'e': [u'é', u'è', u'ê'],
...
# TODO Ronkhar: understand something
def repairedUpper(text):
	""" upper doesn't know about special characters """
	text = text.replace(u'\x9c','&#140;') # œ becomes Œ
	text = text.upper()
	return text
...
OtherFontIcons = { 'happy' : FontSymbols.HAPPY_CHAR,
				...
				'ranged' : FontSymbols.RANGED_CHAR,
				'demon' : FontSymbols.DEMON_CHAR,
				'animal' : FontSymbols.ANIMAL_CHAR,
				'orc' : FontSymbols.ORC_CHAR,
				'furious' : FontSymbols.FURIOUS_CHAR,
				'annoyed' : FontSymbols.ANNOYED_CHAR,
				'cautious' : FontSymbols.CAUTIOUS_CHAR,
				'pleased' : FontSymbols.PLEASED_CHAR,
				'friendly' : FontSymbols.FRIENDLY_CHAR,
				'emergent' : FontSymbols.EMERGENT_CHAR,
				'important' : FontSymbols.IMPORTANT_CHAR,
				'historical' : FontSymbols.HISTORICAL_CHAR,
				}
