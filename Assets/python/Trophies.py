...
def init():
	...
	if not ALL_TROPHIES:
		ALL_TROPHIES=[
			...
			Trophy("TROPHY_DEFEATED_ZARCAZ",CyTranslator().getText("TXT_KEY_TROPHY_DEFEATED_ZARCAZ", ()),'Art/Interface/Buttons/Units/Archer Scorpion Clan.dds','Art/Civs/Other/Archer Scorpion Clan Grey.dds'),
			...
			Trophy("TROPHY_FEAT_GRAND_MENAGERIE",CyTranslator().getText("TXT_KEY_TROPHY_FEAT_GRAND_MENAGERIE", ()),'art/interface/buttons/buildings/GrandMenagerie.dds','art/interface/buttons/trophies/Grand MenagerieGrey.dds'),
			...
			Trophy("TROPHY_VICTORY_MAZATL",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_MAZATL", ()),', ,Art/Spell_Atlas.dds,1,15',', ,Art/Spell_Atlas.dds,2,15'),
			...
			Trophy("TROPHY_VICTORY_SCIONS",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_SCIONS", ()),'Art/Interface/Buttons/Civilizations/Rome.dds',', ,Art/Spell_Atlas.dds,1,5'),
			...
			Trophy("TROPHY_VICTORY_AUSTRIN",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_AUSTRIN", ()),'Art/Interface/Teamcolor/AustrinButton.dds','Art/Civs/Other/austrinbutton.dds'),
			...
			Trophy("TROPHY_VICTORY_CUALLI",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_CUALLI", ()),'Art/Interface/Teamcolor/Cualli-Button.dds','Art/Civs/Other/cualli-button.dds'),
			Trophy("TROPHY_VICTORY_DURAL",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_DURAL", ()),'Art/Interface/Teamcolor/Duralbutton.dds','Art/Civs/Other/duralbutton.dds'),
			Trophy("TROPHY_VICTORY_JOTNAR",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_JOTNAR", ()),'Art/Civs/Jotnar/jotnarcrownbutton.dds','Art/Civs/Other/jotnarcrownbutton.dds'),
			Trophy("TROPHY_VICTORY_KHADI",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_KAHDI", ()),'Art/Interface/Teamcolor/KahdiButton.dds','Art/Civs/Other/kahdibutton.dds'),
			...
			Trophy("TROPHY_VICTORY_FROZEN",CyTranslator().getText("TXT_KEY_TROPHY_VICTORY_FROZEN", ()),'art/interface/TeamColor/Illiansbutton.dds','art/interface/buttons/trophies/IlliansGrey.dds'),
