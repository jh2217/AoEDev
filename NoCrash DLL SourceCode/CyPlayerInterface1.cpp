...
/*************************************************************************************************/
		.def("canConstruct", &CyPlayer::canConstruct, "bool (int /*BuildingTypes*/eBuilding, bool bContinue, bool bTestVisible, bool bIgnoreCost, bool bIgnoreTech)")
/*************************************************************************************************/
/**	AITweak									END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.def("calculateTotalExports", &CyPlayer::calculateTotalCommerceExports, "int (int /*CommerceTypes*/ eCommerce) - Returns the total sum of all city gold generated for other civs via trade routes")
		.def("calculateTotalImports", &CyPlayer::calculateTotalCommerceImports, "int (int /*CommerceTypes*/ eCommerce) - Returns the total sum of all city gold generated for this civ via trade routes with others")
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/************************************************************************************************/
		.def("isFixedBorders", &CyPlayer::isFixedBorders, "bool ()")
		.def("isInfluenceAllowed", &CyPlayer::isInfluenceAllowed, "bool ()")
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.def("setTeam", &CyPlayer::setTeam, "void (int iTeam) - Sets the player's Team to iTeam")
/*************************************************************************************************/
...
/*************************************************************************************************/
		...
		.def("getForeignTradeYieldModifier", &CyPlayer::getForeignTradeYieldModifier, "int (YieldTypes eIndex)")
/*************************************************************************************************/
/**	TradeCommerceModifiers	 				09/05/10								Valkrionn	**/
/**																								**/
/**									Allows trade to grant culture								**/
/*************************************************************************************************/
		.def("getTradeCommerceModifier", &CyPlayer::getTradeCommerceModifier, "int (CommerceTypes eIndex)")
		.def("getForeignTradeCommerceModifier", &CyPlayer::getForeignTradeCommerceModifier, "int (CommerceTypes eIndex)")
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
		...
		.def("isBuildingFree", &CyPlayer::isBuildingFree, "bool (int /*BuildingClassTypes*/ eIndex)")
		...
		.def("getSpecialistCount", &CyPlayer::getSpecialistCount, "bool (int /*SpecialistTypes*/ iIndex)")
		...
		//FlagSystem
		.def("isHasFlag", &CyPlayer::isHasFlag, "bool (int /*FlagTypes*/ iIndex)")
			.def("getFlagValue", &CyPlayer::getFlagValue, "int (int /*FlagTypes*/ iIndex)")
			.def("setHasFlag", &CyPlayer::setHasFlag, "void (int /*FlagTypes*/ iIndex, bool eChange)")
			.def("setFlagValue", &CyPlayer::setFlagValue, "void (int /*FlagTypes*/ iIndex, int eChange)")
