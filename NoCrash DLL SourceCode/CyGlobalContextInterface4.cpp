...
//FfH: End Add
		...
		.def("getSpawnGroupInfo", &CyGlobalContext::getSpawnGroupInfo, python::return_value_policy<python::reference_existing_object>(), "(SpawnGroupID) - CvInfo for SpawnGroupID")

		.def("getNumAffinityInfos", &CyGlobalContext::getNumAffinityInfos, "() - Total Affinity Infos XML\\Units\\CIV4AffinityInfos.xml")
		.def("getAffinityInfo", &CyGlobalContext::getAffinityInfo, python::return_value_policy<python::reference_existing_object>(), "(AffinityID) - CvInfo for AffinityID")
...
//FlavoruMod: Added by Jean Elcard (ClimateSystem)
		.def("getNumClimateZoneInfos", &CyGlobalContext::getNumClimateZoneInfos, "() - Total ClimateZone Infos XML\\Terrain\\CIV4ClimateZoneInfos.xml")
		.def("getClimateZoneInfo", &CyGlobalContext::getClimateZoneInfo, python::return_value_policy<python::reference_existing_object>(), "(ClimateZoneID) - CvInfo for ClimateZoneID")

		.def("getNumTerrainClassInfos", &CyGlobalContext::getNumTerrainClassInfos, "() - Total TerrainClass Infos XML\\Terrain\\CIV4TerrainClassInfos.xml")
		.def("getTerrainClassInfo", &CyGlobalContext::getTerrainClassInfo, python::return_value_policy<python::reference_existing_object>(), "(int (TerrainClassTypes) eTerrainClassID) - CvInfo for TerrainClassID")
//FlavourMod: End Add
		...
		.def("getNumLeaderRelationInfos", &CyGlobalContext::getNumLeaderRelationInfos, "() - Total LeaderRelation Infos XML\\Civilizations\\CIV4LeaderRelationInfos.xml")
		.def("getLeaderRelationInfo", &CyGlobalContext::getLeaderRelationInfo, python::return_value_policy<python::reference_existing_object>(), "(LeaderRelationID) - CvInfo for LeaderRelationID")
		
		.def("getNumLeaderClassInfos", &CyGlobalContext::getNumLeaderClassInfos, "() - Total LeaderClass Infos XML\\Civilizations\\CIV4LeaderClassInfos.xml")
		.def("getLeaderClassInfo", &CyGlobalContext::getLeaderClassInfo, python::return_value_policy<python::reference_existing_object>(), "(LeaderClassID) - CvInfo for LeaderClassID")
