...
/*************************************************************************************************/
int CvArea::getNumEvilTiles() const
{
	return m_iNumEvilTiles;
}

void CvArea::changeNumEvilTiles(int iChange)
{
	m_iNumEvilTiles += iChange;
	FAssertMsg(getNumEvilTiles() <= getNumTiles(), "NumEvilTiles invalid for Area (too many)");
	FAssertMsg(getNumEvilTiles() >= 0, "NumEvilTiles invalid for Area (too few)");
}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
