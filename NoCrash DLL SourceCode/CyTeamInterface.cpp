...
/*************************************************************************************************/
		.def("getBlockBonuses", &CyTeam::getBlockBonuses, "int ()")
		.def("getRevealAllBonuses", &CyTeam::getRevealAllBonuses, "int ()")
		.def("getHideUnits", &CyTeam::getHideUnits, "int ()")
		.def("getSeeInvisible", &CyTeam::getSeeInvisible, "int ()")
		.def("getProjectTimer", &CyTeam::getProjectTimer, "int ()")
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
		;
