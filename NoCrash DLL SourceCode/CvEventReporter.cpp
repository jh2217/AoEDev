...
void CvEventReporter::traitGained(TraitTypes eTrait, PlayerTypes ePlayer)
{
	PROFILE_FUNC();

	m_kPythonEventMgr.reportTraitGained(eTrait, ePlayer);
	//	m_kStatistics.unitKilled(pUnit, eAttacker);
}

void CvEventReporter::traitLost(TraitTypes eTrait, PlayerTypes ePlayer)
{
	PROFILE_FUNC();

	m_kPythonEventMgr.reportTraitLost(eTrait, ePlayer);
	//	m_kStatistics.unitKilled(pUnit, eAttacker);
}
