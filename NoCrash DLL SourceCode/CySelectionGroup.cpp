...
/**								----  End Original Code  ----									**/
bool CySelectionGroup::canFight(bool bIgnoreWorkers, bool bIgnoreSettlers)
{
	return m_pSelectionGroup ? m_pSelectionGroup->canFight(bIgnoreWorkers, bIgnoreSettlers) : false;
}
/*************************************************************************************************/
/**	Tweak									END													**/
/*************************************************************************************************/
