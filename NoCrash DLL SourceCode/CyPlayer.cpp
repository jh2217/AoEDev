...
/*************************************************************************************************/
bool CyPlayer::canConstruct(int /*BuildingTypes*/eBuilding, bool bContinue, bool bTestVisible, bool bIgnoreCost, bool bIgnoreTech)
{
	return m_pPlayer ? m_pPlayer->canConstruct((BuildingTypes)eBuilding, bContinue, bTestVisible, bIgnoreCost, bIgnoreTech) : false;
}
/*************************************************************************************************/
/**	AITweak									END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
int CyPlayer::calculateTotalCommerceExports(int /*CommerceTypes*/ eCommerce)
{
	return m_pPlayer ? m_pPlayer->calculateTotalCommerceImports((CommerceTypes)eCommerce) : -1;
}

int CyPlayer::calculateTotalCommerceImports(int /*CommerceTypes*/ eCommerce)
{
	return m_pPlayer ? m_pPlayer->calculateTotalCommerceImports((CommerceTypes)eCommerce) : -1;
}
/*************************************************************************************************/
...
/************************************************************************************************/
bool CyPlayer::isFixedBorders()
{
	return m_pPlayer ? m_pPlayer->isFixedBorders() : false;
}
bool CyPlayer::isInfluenceAllowed()
{
	return m_pPlayer ? m_pPlayer->isInfluenceAllowed() : false;
}
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
/**	Expose Set Team to Python			03/08/09									Vehem		**/
/**																								**/
/**			Exposes Set Team to Python to be used in Hell Victory 								**/
/*************************************************************************************************/
void CyPlayer::setTeam(int /*TeamTypes*/ iNewTeam)
{
	if (m_pPlayer)
		m_pPlayer->setTeam((TeamTypes)iNewTeam);
}
/*************************************************************************************************/
/**	Expose Set Team to Python				END													**/
/*************************************************************************************************/
...
int CyPlayer::getForeignTradeYieldModifier(YieldTypes eIndex)
{
	return m_pPlayer ? m_pPlayer->getForeignTradeYieldModifier(eIndex) : NO_YIELD;
}
...
/**									Allows trade to grant culture								**/
/*************************************************************************************************/
int CyPlayer::getTradeCommerceModifier(CommerceTypes eIndex)
{
	return m_pPlayer ? m_pPlayer->getTradeCommerceModifier(eIndex) : NO_COMMERCE;
}

int CyPlayer::getForeignTradeCommerceModifier(CommerceTypes eIndex)
{
	return m_pPlayer ? m_pPlayer->getForeignTradeCommerceModifier(eIndex) : NO_COMMERCE;
}
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
{
	return m_pPlayer ? m_pPlayer->isBuildingFree((BuildingClassTypes)iIndex) : false;
}
...
/*************************************************************************************************/
int CyPlayer::getInitialCityCap() const
{
	return m_pPlayer ? m_pPlayer->getInitialCityCap() : 0;
}
void CyPlayer::setInitialCityCap(int iNewValue)
{
	if (m_pPlayer)
	   m_pPlayer->setInitialCityCap(iNewValue);
}
int CyPlayer::getMaxCityCap() const
{
	return m_pPlayer ? m_pPlayer->getMaxCityCap() : 0;
}
void CyPlayer::setMaxCityCap(int iNewValue)
{
	if (m_pPlayer)
	   m_pPlayer->setMaxCityCap(iNewValue);
}
int CyPlayer::getPopulationCap() const
{
	return m_pPlayer ? m_pPlayer->getPopulationCap() : 0;
}
void CyPlayer::setPopulationCap(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->setPopulationCap(iNewValue);
}
void CyPlayer::changePopulationCap(int iChange)
{
	if (m_pPlayer)
	   m_pPlayer->changePopulationCap(iChange);
}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
int CyPlayer::getGlobalCounterContrib() const
{
	return m_pPlayer ? m_pPlayer->getGlobalCounterContrib() : 0;
}
void CyPlayer::changeGlobalCounterContrib(int iChange)
{
	if (m_pPlayer)
	m_pPlayer->changeGlobalCounterContrib(iChange);
}
bool CyPlayer::isIgnoreFood() const
{
	return m_pPlayer ? m_pPlayer->isIgnoreFood() : false;
}
bool CyPlayer::isIgnoreHealth() const
{
	return m_pPlayer ? m_pPlayer->isIgnoreHealth() : false;
}
int CyPlayer::getModReligionSpreadChance()
{
	return m_pPlayer ? m_pPlayer->getModReligionSpreadChance() : 0;
}
void CyPlayer::changeModReligionSpreadChance(int iChange)
{
	if (m_pPlayer)
	m_pPlayer->changeModReligionSpreadChance(iChange);
}
int CyPlayer::getBroadAlignment()
{
	return m_pPlayer ? (int) m_pPlayer->getBroadAlignment() : -99999;
}
void CyPlayer::changeBroadEventModifier(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeBroadEventModifier(iChange);
}
/*************************************************************************************************/
...
/*************************************************************************************************/
void CyPlayer::changeBroadShiftModifier(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeBroadShiftModifier(iChange);
}
void CyPlayer::updateAlignmentShift()
{
	if (m_pPlayer)
		m_pPlayer->updateAlignmentShift();
}
/*************************************************************************************************/
/**	Broader Alignments Expansion				END												**/
/*************************************************************************************************/
void CyPlayer::updateAlignment()
{
	if (m_pPlayer)
		m_pPlayer->updateAlignment();
}
void CyPlayer::setBroadAlignment(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->setBroadAlignment(iNewValue);
}
/*************************************************************************************************/
...
/*************************************************************************************************/
int CyPlayer::getBroadEthicalAlignment()
{
	return m_pPlayer ? (int) m_pPlayer->getBroadEthicalAlignment() : -99999;
}
void CyPlayer::changeBroadEthicalEventModifier(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeBroadEthicalEventModifier(iChange);
}
void CyPlayer::changeBroadEthicalShiftModifier(int iChange)
{
	if (m_pPlayer)
		m_pPlayer->changeBroadEthicalShiftModifier(iChange);
}
void CyPlayer::updateEthicalAlignmentShift()
{
	if (m_pPlayer)
		m_pPlayer->updateEthicalAlignmentShift();
}
void CyPlayer::updateEthicalAlignment()
{
	if (m_pPlayer)
		m_pPlayer->updateEthicalAlignment();
}
void CyPlayer::setBroadEthicalAlignment(int iNewValue)
{
	if (m_pPlayer)
		m_pPlayer->setBroadEthicalAlignment(iNewValue);
}
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/
bool CyPlayer::isHideUnits()
{
	return m_pPlayer ? m_pPlayer->isHideUnits() : false;
}
bool CyPlayer::isSeeInvisible()
{
	return m_pPlayer ? m_pPlayer->isSeeInvisible() : false;
}
int CyPlayer::getPotency() const
{
	return m_pPlayer ? m_pPlayer->getPotency() : 0;
}
float CyPlayer::getPotencyAffinity(int iI) const
{
	return m_pPlayer ? m_pPlayer->getPotencyAffinity(iI) : 0;
}
int CyPlayer::getPotencyBonusPrereq(int iI) const
{
	return m_pPlayer ? m_pPlayer->getPotencyBonusPrereq(iI) : 0;
}
int CyPlayer::getShielding() const
{
	return m_pPlayer ? m_pPlayer->getShielding() : 0;
}
float CyPlayer::getShieldingAffinity(int iI) const
{
	return m_pPlayer ? m_pPlayer->getShieldingAffinity(iI) : 0;
}
int CyPlayer::getShieldingBonusPrereq(int iI) const
{
	return m_pPlayer ? m_pPlayer->getShieldingBonusPrereq(iI) : 0;
}
int CyPlayer::getTrainXPCap(int iI) const
{
	return m_pPlayer ? m_pPlayer->getTrainXPCap(iI) : 0;
}
float CyPlayer::getTrainXPRate(int iI) const
{
	return m_pPlayer ? m_pPlayer->getTrainXPRate(iI) : 0;
}
...
{
	return m_pPlayer ? (int) m_pPlayer->getStateNameType() : NO_STATENAME;
}
void CyPlayer::updateStateNameType()
{
	if (m_pPlayer)
		m_pPlayer->updateStateNameType();
}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/**							Adds a new alignment axis to the game								**/
/*************************************************************************************************/
int CyPlayer::getEthicalAlignment() const
{
	return m_pPlayer ? (int) m_pPlayer->getEthicalAlignment() : NO_ETHICAL_ALIGNMENT;
}

void CyPlayer::setEthicalAlignment(int iEthicalAlignment)
{
	if (m_pPlayer)
		m_pPlayer->setEthicalAlignment(iEthicalAlignment);
}
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/
...
/*************************************************************************************************/
int CyPlayer::getLeaderStatus() const
{
	return m_pPlayer ? (int) m_pPlayer->getLeaderStatus() : NO_STATUS;
}

void CyPlayer::setLeaderStatus(int iLeaderStatus)
{
	if (m_pPlayer)
		m_pPlayer->setLeaderStatus(iLeaderStatus);
}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
{
	return m_pPlayer ? m_pPlayer->isIntolerant() : false;
}
/*************************************************************************************************/
/** End                                                                                         **/
/*************************************************************************************************/
//FlagSystem
bool CyPlayer::isHasFlag(int /*FlagTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->isHasFlag((FlagTypes)iIndex) : false;
}
int CyPlayer::getFlagValue(int /*FlagTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getFlagValue((FlagTypes)iIndex) : 0;
}
...
int CyPlayer::getTraitPoints(int/*TraitTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getTraitPoints((TraitTypes)iIndex) : 0;
}
void CyPlayer::setTraitPoints(int/*TraitTypes*/ iIndex, int iValue)
{
	if (m_pPlayer)
		m_pPlayer->setTraitPoints((TraitTypes)iIndex, iValue);
}
int CyPlayer::getMinRequiredPoints(int/*TraitTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getMinRequiredPoints((TraitTypes)iIndex) : 0;
}
int CyPlayer::getMinRequiredPointsNextTrait(int/*TraitTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getMinRequiredPointsNextTrait((TraitTypes)iIndex) : 0;
}
int CyPlayer::getNumTraitPerClass(int/*TraitClassTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getNumTraitPerClass((TraitClassTypes)iIndex) : 0;
}
int CyPlayer::getNumMaxTraitPerClass(int/*TraitClassTypes*/ iIndex)
{
	return m_pPlayer ? m_pPlayer->getNumMaxTraitPerClass((TraitClassTypes)iIndex) : 0;
}

void CyPlayer::setNumMaxTraitPerClass(int/*TraitClassTypes*/ iIndex,int iNewValue)
{
	if (m_pPlayer)
	{
		m_pPlayer->setNumMaxTraitPerClass((TraitClassTypes)iIndex, iNewValue);
		m_pPlayer->initValidTraitTriggers();
	}
}
void CyPlayer::initValidTraitTriggers()
{

	if (m_pPlayer)
	{
		m_pPlayer->initValidTraitTriggers(false);
	}
}
void CyPlayer::setGainingTrait(bool val) {
	if (m_pPlayer)
	{
