...
void CyStructsPythonInterface1()
{
	...
	python::class_<CombatDetails>("CombatDetails")
		...
		.def_readwrite("iPlotEffectAttackModifier", &CombatDetails::iPlotEffectAttackModifier)
		.def_readwrite("iPlotEffectDefenseModifier", &CombatDetails::iPlotEffectDefenseModifier)
...
/*************************************************************************************************/
	python::class_<CityBonuses>("CityBonuses")
		.def_readwrite("bFullMap", &CityBonuses::bFullMap)
		.def_readwrite("bApplyEnemy", &CityBonuses::bApplyEnemy)
		.def_readwrite("bApplyRival", &CityBonuses::bApplyRival)
		.def_readwrite("bApplySelf", &CityBonuses::bApplySelf)
		.def_readwrite("bApplyTeam", &CityBonuses::bApplyTeam)
		.def_readwrite("fCulture", &CityBonuses::fCulture)
		.def_readwrite("fDefense", &CityBonuses::fDefense)
		.def_readwrite("fDiplo", &CityBonuses::fDiplo)
		.def_readwrite("fFood", &CityBonuses::fFood)
		.def_readwrite("fFreeXP", &CityBonuses::fFreeXP)
		.def_readwrite("fGold", &CityBonuses::fGold)
		.def_readwrite("fGPP", &CityBonuses::fGPP)
		.def_readwrite("fHappy", &CityBonuses::fHappy)
		.def_readwrite("fHealth", &CityBonuses::fHealth)
		.def_readwrite("fProduction", &CityBonuses::fProduction)
		.def_readwrite("fTradeRoutes", &CityBonuses::fTradeRoutes)
		.def_readwrite("fRitualAssist", &CityBonuses::fRitualAssist)
		.def_readwrite("fInfectCulture", &CityBonuses::fInfectCulture)
		.def_readwrite("fPotency", &CityBonuses::fPotency)
		.def_readwrite("fShielding", &CityBonuses::fShielding)
		.def_readwrite("fTrainXPCap", &CityBonuses::fTrainXPCap)
		.def_readwrite("fTrainXPRate", &CityBonuses::fTrainXPRate)
		.def_readwrite("iBonusRange", &CityBonuses::iBonusRange)
		.def_readwrite("fDecayRate", &CityBonuses::fDecayRate)
		;
/*************************************************************************************************/
/**	People's Choice							END													**/
/*************************************************************************************************/
