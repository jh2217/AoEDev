...
/*************************************************************************************************/
	...
	void changeBlockBonuses(int iChange);

	int getRevealAllBonuses();
	void changeRevealAllBonuses(int iChange);
	...
	void RestoreProjectCount(ProjectTypes eProject);

	bool isColony() const;
	void setColony(bool bNewValue);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
