...
public:
	...
	bool isHasMaxLevelTrait(TraitTypes eTrait) const;
	int getNextGainableTrait(TraitTypes eTrait) const;
	int getMaxOwnedTrait(TraitTypes eTrait) const;
	void initValidTraitTriggers(bool bFirstTime=true);
	void doTraitTriggers(TraitHookTypes eTraitHook, const TraitTriggeredData* kData);
	int getTraitPoints(TraitTypes eTrait) const;
	void setTraitPoints(TraitTypes eTrait, int iNewValue);
	void changeTraitPoints(TraitTypes eTrait, int iChange);
	int getMinRequiredPoints(TraitTypes eTrait) const;
	int getMinRequiredPointsNextTrait(TraitTypes eTrait) const;
	void handleTraitLevels(TraitTypes eTrait, int iChange);
	int getNumTraitPerClass(TraitClassTypes eClass) const;
	void setNumTraitPerClass(TraitClassTypes eClass, int iNewValue);
	void changeNumTraitPerClass(TraitClassTypes eClass, int iChange);
	int getNumMaxTraitPerClass(TraitClassTypes eClass) const;
	void setNumMaxTraitPerClass(TraitClassTypes eClass, int iNewValue);
	void changeNumMaxTraitPerClass(TraitClassTypes eClass, int iChange);
	bool isValidTraitTrigger(TraitTriggerTypes eTrigger) const;
	void setValidTraitTrigger(TraitTriggerTypes eTrigger,bool iChange);
...
/**																								**/
/**				Sometimes called thousands of times per turn, which is slow						**/
/*************************************************************************************************/
	void updateRouteCache();
	RouteTypes getBestRouteCache() const;
/*************************************************************************************************/
/**	Speedup									END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int calculateTotalCommerceExports(CommerceTypes eCommerce) const;																										// Exposed to Python
	int calculateTotalCommerceImports(CommerceTypes eCommerce) const;
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/																										// Exposed to Python
...
/*************************************************************************************************/
	...
	DllExport int getCrimePerTurn() const;																																			// Exposed to Python
	...
	bool isGainingTrait() const;
	DllExport void setGainingTrait(bool bNewValue);
...
//FfH: End Modify
	...
	int getForeignTradeYieldModifier(YieldTypes eIndex) const;																								// Exposed to Python
	void changeForeignTradeYieldModifier(YieldTypes eIndex, int iChange);
...
/**									Allows trade to grant culture								**/
/*************************************************************************************************/
	int getTradeCommerceModifier(CommerceTypes eIndex) const;
	void changeTradeCommerceModifier(CommerceTypes eIndex, int iChange);

	int getForeignTradeCommerceModifier(CommerceTypes eIndex) const;
	void changeForeignTradeCommerceModifier(CommerceTypes eIndex, int iChange);
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
	...
	int getTradeDefenderAttitudeByPlayer(PlayerTypes eIndex) const;																							// Exposed to Python
	void changeTradeDefenderAttitudeByPlayer(PlayerTypes eIndex, int iChange);
	int getTradeDefenderDecayByPlayer(PlayerTypes eIndex) const;																							// Exposed to Python
	void changeTradeDefenderDecayByPlayer(PlayerTypes eIndex, int iChange);
	...
	int getFreeBuildingCount(BuildingClassTypes eIndex) const;
	bool isBuildingFree(BuildingClassTypes eIndex) const;																									// Exposed to Python
	void changeFreeBuildingCount(BuildingClassTypes eIndex, int iChange);
	...
	int getUnitClassPlayerInstancesChanges(UnitClassTypes eIndex) const;
	void changeUnitClassPlayerInstancesChanges(UnitClassTypes eIndex, int iChange);
	...
	bool findEmptyPlotGroup(CvPlot* pPlot);
	CvPlotGroup* findPlotGroup(CvPlot* pPlot);
	// city iteration
...
/**								----  End Original Code  ----									**/
	void setEventOccured(EventTypes eEvent, EventTriggeredData& kEventTriggered, bool bOthers = true);
/*************************************************************************************************/
/**	Tweak									END													**/
/*************************************************************************************************/
	...
	int getExtraGrowthThreshold() const;
	void changeExtraGrowthThreshold(int iChange);
	int getACGrowthThreshold() const;
	void changeACGrowthThreshold(int iChange);
...
/*************************************************************************************************/
	void updateCityBonuses(bool bApply);
	void updateShroudedUnits();
	DllExport int getBroadAlignment() const;
	void setBroadAlignment(int iNewValue);
	void changeBroadAlignment(int iChange);
	int getBroadEventModifier() const;
	void setBroadEventModifier(int iNewValue);
	DllExport void changeBroadEventModifier(int iChange);
/*************************************************************************************************/
/**	Expanded Broader Alignments 			11/03/09								Valkrionn	**/
/**																								**/
/**								Used to determine per turn shifts								**/
/*************************************************************************************************/
	int getBroadShiftModifier() const;
	void setBroadShiftModifier(int iNewValue);
	DllExport void changeBroadShiftModifier(int iChange);
	int getBroadShiftAmount() const;
	void setBroadShiftAmount(int iNewValue);
	DllExport void changeBroadShiftAmount(int iChange);
	int getBroadShiftTurns() const;
	void setBroadShiftTurns(int iNewValue);
	DllExport void changeBroadShiftTurns(int iChange);
	DllExport void updateAlignmentShift();
/*************************************************************************************************/
/**	Broader Alignments Expansion				END												**/
/*************************************************************************************************/
	DllExport void updateAlignment();
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments 				11/06/09								Valkrionn	**/
/**																								**/
/**							Adds a new alignment axis to the game								**/
/*************************************************************************************************/
	DllExport int getBroadEthicalAlignment() const;
	void setBroadEthicalAlignment(int iNewValue);
	void changeBroadEthicalAlignment(int iChange);
	int getBroadEthicalEventModifier() const;
	void setBroadEthicalEventModifier(int iNewValue);
	DllExport void changeBroadEthicalEventModifier(int iChange);
	int getBroadEthicalShiftModifier() const;
	void setBroadEthicalShiftModifier(int iNewValue);
	DllExport void changeBroadEthicalShiftModifier(int iChange);
	int getBroadEthicalShiftAmount() const;
	void setBroadEthicalShiftAmount(int iNewValue);
	DllExport void changeBroadEthicalShiftAmount(int iChange);
	int getBroadEthicalShiftTurns() const;
	void setBroadEthicalShiftTurns(int iNewValue);
	DllExport void changeBroadEthicalShiftTurns(int iChange);
	DllExport void updateEthicalAlignmentShift();
	DllExport void updateEthicalAlignment();
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/

	int getUpkeepCosts() const;																																		// Exposed to Python
	void changeUpkeepCosts(int iChange);

	int getModReligionSpreadChance() const;																																		// Exposed to Python
	void changeModReligionSpreadChance(int iChange);
	...
	bool isRevealBonus(int iI);
	void setRevealBonus(bool fChange, int iI);
	
	bool isNoBonus(int iI) const;
	void changeNoBonus(int fChange, int iI);
	...
	DllExport CvWString getStateName() const;
	StateNameTypes getStateNameType() const;
	void setStateNameType(StateNameTypes eNewStateNameType);
	DllExport void updateStateNameType();
	bool canHaveStateNameType(StateNameTypes eStateNameType);
	int getNumCitiesConquered() const;
	void changeNumCitiesConquered(int iChange);

	int getRecentTechScore() const;
	void setRecentTechScore(int iNewValue);
	int getGlobalCounterContrib() const;
...
/**								----  End Original Code  ----									**/
	...
	bool isHideUnits() const;
	void changeHideUnits(int iChange);
...
/************************************************************************************************/
	...
	void changeFixedBorders(int iChange);
	...
	void changeInfluenceAllowed(int iChange);
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	void setNomadic(bool bNewValue);
/*************************************************************************************************/
/**	Nomadic									END													**/
/*************************************************************************************************/
...
/**							Adds a new alignment axis to the game								**/
/*************************************************************************************************/
	DllExport int getEthicalAlignment() const;
	void setEthicalAlignment(int iNewValue);
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	DllExport int getLeaderStatus() const;
	void setLeaderStatus(int iNewValue);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	DllExport void changeDisableProduction(int iChange);
	...
	DllExport int getPlayersKilled() const;
...
/*************************************************************************************************/
	...
	void setInitialCityCap(int iNewValue);
	int getMaxCityCap() const;
	void setMaxCityCap(int iNewValue);
	int getPopulationCap() const;
	void setPopulationCap(int iNewValue);
	void changePopulationCap(int iChange);
/*************************************************************************************************/
/** CityPopCap                  END                                                             **/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	GoodyTypes doLair(CvPlot* pPlot, CvUnit* pUnit);
/*************************************************************************************************/
/**	MISSION_EXPLORE_LAIR					END													**/
/*************************************************************************************************/
	//FlagSystem
	bool isHasFlag(FlagTypes eFlag)const;
	int getFlagValue(FlagTypes eFlag)const;
	void setHasFlag(FlagTypes eFlag, bool eChange);
	void setFlagValue(FlagTypes eFlag, int eChange);
	void changeFlagValue(FlagTypes eFlag, int eChange);
	int pickOtherPlayerFlags(EventTriggerTypes eTrigger);
...
/**								----  End Original Code  ----									**/
	virtual int AI_getPlotDanger(CvPlot* pPlot, int iRange = -1, bool bTestMoves = true, int iThreshold = 50) const = 0; //Default to 50 because we almost never want to check beyond that, too slow and 50 = VERY FREAKING DANGEROUS.
/*************************************************************************************************/
/**	Speedup									END													**/
/*************************************************************************************************/
...
/**								---- Start Original Code ----									**
	...
	/**								----  End Original Code  ----									**/
	virtual TechTypes AI_bestTech(int iMaxPathLength = 1, bool bIgnoreCost = false, bool bAsync = false, TechTypes eIgnoreTech = NO_TECH, AdvisorTypes eIgnoreAdvisor = NO_ADVISOR, bool bResearch = false) = 0;
/*************************************************************************************************/
/**	Improved AI								END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int m_iBroadAlignment;
	int m_iBroadEventModifier;
/*************************************************************************************************/
/**	Expanded Broader Alignments 			11/03/09								Valkrionn	**/
/**																								**/
/**								Used to determine per turn shifts								**/
/*************************************************************************************************/
	int m_iBroadShiftModifier;
	int m_iBroadShiftAmount;
	int m_iBroadShiftTurns;
/*************************************************************************************************/
/**	Broader Alignments Expansion				END												**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**							Adds a new alignment axis to the game								**/
/*************************************************************************************************/
	int m_iBroadEthicalAlignment;
	int m_iBroadEthicalEventModifier;
	int m_iBroadEthicalShiftModifier;
	int m_iBroadEthicalShiftAmount;
	int m_iBroadEthicalShiftTurns;
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/
	int m_iUpkeepCosts;
	...
	short m_eStateNameType;
	int m_iNumCitiesConquered;

	int m_iRecentTechScore;
	int m_iGlobalCounterContrib;
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
//FfH Traits: Added by Kael 08/02/2007
...
/*************************************************************************************************/
	...
	int* m_aiForeignTradeYieldModifier;
/*************************************************************************************************/
/**	TradeCommerceModifiers	 				09/05/10								Valkrionn	**/
/**																								**/
/**									Allows trade to grant culture								**/
/*************************************************************************************************/
	int* m_aiTradeCommerceModifier;
	int* m_aiForeignTradeCommerceModifier;
/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
	...
	int* m_aiTradeDefenderDecayByPlayer;
...
/**																								**/
/**							Declaration of CivPlotMods specific fields.							**/
/*************************************************************************************************/
