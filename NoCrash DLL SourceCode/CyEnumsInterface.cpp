...
void CyEnumsPythonInterface()
{
	...
	python::enum_<AreaBorderLayers>("AreaBorderLayers")
		...
		.value("AREA_BORDER_LAYER_TARGETED_SPELL", AREA_BORDER_LAYER_TARGETED_SPELL)
	...
	python::enum_<InterfaceModeTypes>("InterfaceModeTypes")
		...
		//TargetedSpell 0924 blackimp
		.value("INTERFACEMODE_TARGETED_SPELL", INTERFACEMODE_TARGETED_SPELL)
...
/*************************************************************************************************/
		.value("WIDGET_PEDIA_JUMP_TO_SPAWNGROUP", WIDGET_PEDIA_JUMP_TO_SPAWNGROUP)
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.value("WIDGET_PEDIA_JUMP_TO_AFFINITY", WIDGET_PEDIA_JUMP_TO_AFFINITY)
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
...
/**																								**/
/**								Exposes the Widget to Python									**/
/*************************************************************************************************/
		.value("WIDGET_SLAVE_LIST", WIDGET_SLAVE_LIST)
		.value("WIDGET_MASTER_UNIT", WIDGET_MASTER_UNIT)
		.value("WIDGET_MINION_LIST", WIDGET_MINION_LIST)
		.value("WIDGET_COMMANDER_UNIT", WIDGET_COMMANDER_UNIT)
		.value("WIDGET_ARMAGEDDON_COUNTER", WIDGET_ARMAGEDDON_COUNTER)
		.value("WIDGET_RESTRICT_CIV", WIDGET_RESTRICT_CIV)
		.value("WIDGET_HELP_CIVIC", WIDGET_HELP_CIVIC)
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.value("WIDGET_CITY_ACTION", WIDGET_CITY_ACTION)
/*************************************************************************************************/
/**	City Actions							END													**/
/*************************************************************************************************/
//Crime
		.value("WIDGET_HELP_CRIME", WIDGET_HELP_CRIME)
			.value("WIDGET_PEDIA_JUMP_TO_PLOT_EFFECT", WIDGET_PEDIA_JUMP_TO_PLOT_EFFECT)
			.value("WIDGET_PEDIA_JUMP_TO_CITYCLASS", WIDGET_PEDIA_JUMP_TO_CITYCLASS)
	...
	python::enum_<WorldSizeTypes>("WorldSizeTypes")
		...
		.value("WORLDSIZE_HUGER", WORLDSIZE_HUGER)
...
/*************************************************************************************************/
	python::enum_<CivFlavorTypes>("CivFlavorTypes")
		.value("NO_CIVFLAVOR", NO_CIVFLAVOR)
		;
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_VISIBLE_BARBARIANS", GAMEOPTION_NO_VISIBLE_BARBARIANS)
...
//FfH: Added by Kael 09/25/2007
		.value("GAMEOPTION_BARBARIAN_WORLD", GAMEOPTION_BARBARIAN_WORLD)
		.value("GAMEOPTION_DOUBLE_ANIMALS", GAMEOPTION_DOUBLE_ANIMALS)

//FFPlus: Added by Valkrionn
		.value("GAMEOPTION_TIMID_ANIMALS", GAMEOPTION_TIMID_ANIMALS)

		.value("GAMEOPTION_DOUBLE_BONUSES", GAMEOPTION_DOUBLE_BONUSES)
		.value("GAMEOPTION_DOUBLE_EVENTS", GAMEOPTION_DOUBLE_EVENTS)

//FFPlus: Added by Valkrionn
		.value("GAMEOPTION_WILD_MANA", GAMEOPTION_WILD_MANA)
		.value("GAMEOPTION_FERAL_MANA", GAMEOPTION_FERAL_MANA)
		.value("GAMEOPTION_MANA_GUARDIANS", GAMEOPTION_MANA_GUARDIANS)
		.value("GAMEOPTION_NO_LIBERATION", GAMEOPTION_NO_LIBERATION)

		.value("GAMEOPTION_DOUBLE_GLOBAL_COUNTER", GAMEOPTION_DOUBLE_GLOBAL_COUNTER)
		.value("GAMEOPTION_NO_GLOBAL_COUNTER", GAMEOPTION_NO_GLOBAL_COUNTER)
		.value("GAMEOPTION_NO_HYBOREM_OR_BASIUM", GAMEOPTION_NO_HYBOREM_OR_BASIUM)
		.value("GAMEOPTION_NO_LAIRS", GAMEOPTION_NO_LAIRS)
		.value("GAMEOPTION_NO_PLOT_COUNTER", GAMEOPTION_NO_PLOT_COUNTER)
		.value("GAMEOPTION_NO_CRIME", GAMEOPTION_NO_CRIME)
		.value("GAMEOPTION_NO_SETTLERS", GAMEOPTION_NO_SETTLERS)
		...
		.value("GAMEOPTION_ALL_UNIQUE_IMPROVEMENTS", GAMEOPTION_ALL_UNIQUE_IMPROVEMENTS)
		.value("GAMEOPTION_NO_UNIQUE_IMPROVEMENTS", GAMEOPTION_NO_UNIQUE_IMPROVEMENTS)
		...
		.value("GAMEOPTION_NO_RELIGION_7", GAMEOPTION_NO_RELIGION_7)
		.value("GAMEOPTION_NO_WORLD_SPELLS", GAMEOPTION_NO_WORLD_SPELLS)
		.value("GAMEOPTION_NO_ACHERON", GAMEOPTION_NO_ACHERON)
		.value("GAMEOPTION_NO_DUIN", GAMEOPTION_NO_DUIN)
		.value("GAMEOPTION_NO_ORTHUS", GAMEOPTION_NO_ORTHUS)
		.value("GAMEOPTION_NO_AUTOCAST", GAMEOPTION_NO_AUTOCAST)
		.value("GAMEOPTION_NO_NATIONAL_LIMIT", GAMEOPTION_NO_NATIONAL_LIMIT)
...
//FfH: End Add
/*************************************************************************************************/
/**	New Tag Defs	(GameOptions)			05/15/08								Xienwolf	**/
/**																								**/
...
/*************************************************************************************************/
		.value("GAMEOPTION_THE_ACKNOWLEDGEMENT", GAMEOPTION_THE_ACKNOWLEDGEMENT)
		.value("GAMEOPTION_WELLKNOWN_FACES", GAMEOPTION_WELLKNOWN_FACES)
/*************************************************************************************************/
/** End                                                                                         **/
/*************************************************************************************************/
		.value("GAMEOPTION_FLAVOUR_START", GAMEOPTION_FLAVOUR_START)
		.value("GAMEOPTION_NO_WORKER_XP", GAMEOPTION_NO_WORKER_XP)
		.value("GAMEOPTION_DARK_FORESTS", GAMEOPTION_DARK_FORESTS)
			.value("GAMEOPTION_DELAYED_LAIRS", GAMEOPTION_DELAYED_LAIRS)
			.value("GAMEOPTION_REALISTIC_CULTURE_SPREAD", GAMEOPTION_REALISTIC_CULTURE_SPREAD)
		.value("GAMEOPTION_ENABLE_COMBAT_LOG", GAMEOPTION_ENABLE_COMBAT_LOG)
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/**								Adds new Game Options											**/
/*************************************************************************************************/
		.value("MPOPTION_RANDOM_LOGGER", MPOPTION_RANDOM_LOGGER)
		.value("MPOPTION_ENABLE_AUTOPLAY", MPOPTION_ENABLE_AUTOPLAY)
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	...
	python::enum_<PlayerOptionTypes>("PlayerOptionTypes")
		...
		.value("PLAYEROPTION_EVENTS_SHOW_BLOCKED_ANSWERS", PLAYEROPTION_EVENTS_SHOW_BLOCKED_ANSWERS)
...
/*************************************************************************************************/
	python::enum_<GoodyClassTypes>("GoodyClassTypes")
		.value("NO_GOODYCLASS", NO_GOODYCLASS)
		;
/*************************************************************************************************/
...
/*************************************************************************************************/
/*************************************************************************************************/
/**	LeaderStatus Infos						10/18/09								Valkrionn	**/
/*************************************************************************************************/
		.value("EMERGENT_CHAR", EMERGENT_CHAR)
		.value("IMPORTANT_CHAR", IMPORTANT_CHAR)
		.value("HISTORICAL_CHAR", HISTORICAL_CHAR)
/*************************************************************************************************/
/**	LeaderStatus							END													**/
/*************************************************************************************************/
		.value("CRIME_CHAR", CRIME_CHAR)
	...
	python::enum_<LoreTypes>("LoreTypes")
		.value("NO_LORE", NO_LORE)
		;
...
/*************************************************************************************************/
		.value("MISSION_PILLAGE_ROUTE", MISSION_PILLAGE_ROUTE)
/*************************************************************************************************/
/**	Route Pillage							END			**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.value("MISSION_CLAIM_FORT", MISSION_CLAIM_FORT)
		.value("MISSION_EXPLORE_LAIR", MISSION_EXPLORE_LAIR)
/*************************************************************************************************/
...
/*************************************************************************************************/
/**	New Tag Defs	(FeatInfos)				05/15/08								Xienwolf	**/
/**																								**/
/**									Adds new Feats												**/
/*************************************************************************************************/
		.value("FEAT_VISIT_POOL_OF_TEARS", FEAT_VISIT_POOL_OF_TEARS)
		.value("FEAT_VISIT_SIRONAS_BEACON", FEAT_VISIT_SIRONAS_BEACON)
		.value("FEAT_VISIT_MIRROR_OF_HEAVEN", FEAT_VISIT_MIRROR_OF_HEAVEN)
		.value("FEAT_VISIT_REMNANTS_OF_PATRIA", FEAT_VISIT_REMNANTS_OF_PATRIA)
		.value("FEAT_VISIT_ODIOS_PRISON", FEAT_VISIT_ODIOS_PRISON)
		.value("FEAT_VISIT_BRADELINES_WELL", FEAT_VISIT_BRADELINES_WELL)
/*************************************************************************************************/
/** Adding more UFs					Opera														**/
/*************************************************************************************************/
		.value("FEAT_VISIT_AIFON_ISLE", FEAT_VISIT_AIFON_ISLE)
		.value("FEAT_VISIT_BAIR_OF_LACUNA", FEAT_VISIT_BAIR_OF_LACUNA)
		.value("FEAT_VISIT_BROKEN_SEPULCHER", FEAT_VISIT_BROKEN_SEPULCHER)
		.value("FEAT_VISIT_CLIFFS_OF_KELLE", FEAT_VISIT_CLIFFS_OF_KELLE)
		.value("FEAT_VISIT_FOXFORD", FEAT_VISIT_FOXFORD)
		.value("FEAT_VISIT_GUARDIAN_PRISTIN_PASS", FEAT_VISIT_GUARDIAN_PRISTIN_PASS)
		.value("FEAT_VISIT_LETUM_FRIGUS", FEAT_VISIT_LETUM_FRIGUS)
		.value("FEAT_VISIT_MAELSTROM", FEAT_VISIT_MAELSTROM)
		.value("FEAT_VISIT_MOUNT_KALSHEKK", FEAT_VISIT_MOUNT_KALSHEKK)
		.value("FEAT_VISIT_PYRE_OF_THE_SERAPHIC", FEAT_VISIT_PYRE_OF_THE_SERAPHIC)
		.value("FEAT_VISIT_RING_OF_CARCER", FEAT_VISIT_RING_OF_CARCER)
		.value("FEAT_VISIT_RINWELL_ISLE", FEAT_VISIT_RINWELL_ISLE)
		.value("FEAT_VISIT_SEVEN_PINES", FEAT_VISIT_SEVEN_PINES)
		.value("FEAT_VISIT_STANDING_STONES", FEAT_VISIT_STANDING_STONES)
		.value("FEAT_VISIT_TOMB_OF_SUCELLUS", FEAT_VISIT_TOMB_OF_SUCELLUS)
		.value("FEAT_VISIT_TOWER_OF_EYES", FEAT_VISIT_TOWER_OF_EYES)
		.value("FEAT_VISIT_YGGDRASIL", FEAT_VISIT_YGGDRASIL)
/*************************************************************************************************/
/** Adding more UFs					END															**/
/*************************************************************************************************/
		.value("FEAT_BUILT_KEEP", FEAT_BUILT_KEEP)
...
/**									  End Original Code											**/
		.value("CIVILOPEDIA_PAGE_TERRAIN", CIVILOPEDIA_PAGE_TERRAIN)
		.value("CIVILOPEDIA_PAGE_FEATURE", CIVILOPEDIA_PAGE_FEATURE)
		.value("CIVILOPEDIA_PAGE_PLOT_EFFECT", CIVILOPEDIA_PAGE_PLOT_EFFECT)
		.value("CIVILOPEDIA_PAGE_BONUS", CIVILOPEDIA_PAGE_BONUS)
		.value("CIVILOPEDIA_PAGE_IMPROVEMENT", CIVILOPEDIA_PAGE_IMPROVEMENT)
		.value("CIVILOPEDIA_PAGE_SPECIALIST", CIVILOPEDIA_PAGE_SPECIALIST)
		.value("CIVILOPEDIA_PAGE_PROMOTION", CIVILOPEDIA_PAGE_PROMOTION)
		...
		.value("CIVILOPEDIA_PAGE_CIV", CIVILOPEDIA_PAGE_CIV)
		.value("CIVILOPEDIA_PAGE_LEADER", CIVILOPEDIA_PAGE_LEADER)
		.value("CIVILOPEDIA_PAGE_CITYCLASS", CIVILOPEDIA_PAGE_CITYCLASS)
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
		.value("CIVILOPEDIA_PAGE_SPAWNGROUP", CIVILOPEDIA_PAGE_SPAWNGROUP)
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					Vastly improved Affinity system, open to many tags							**/
/*************************************************************************************************/
		.value("CIVILOPEDIA_PAGE_AFFINITY", CIVILOPEDIA_PAGE_AFFINITY)
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
		.value("CIVILOPEDIA_PAGE_LORE", CIVILOPEDIA_PAGE_LORE)
		.value("CIVILOPEDIA_PAGE_CONCEPT", CIVILOPEDIA_PAGE_CONCEPT)
/*************************************************************************************************/
/**	NewPedia								END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	python::enum_<LeaderRelationTypes>("LeaderRelationTypes")
		.value("NO_LEADERRELATION", NO_LEADERRELATION)
		;
/*************************************************************************************************/
/**	End																							**/
/*************************************************************************************************/
		//PromotionClass
	python::enum_<PromotionClassTypes>("PromotionClassTypes")
		.value("NO_PROMOTIONCLASS", NO_PROMOTIONCLASS)
		;
	//CityClass
	python::enum_<CityClassTypes>("CITYClassTypes")
		.value("NO_CITYCLASS", NO_CITYCLASS)
		;
	//TraitClass
	python::enum_<TraitClassTypes>("TraitClassTypes")
		.value("NO_TRAITCLASS", NO_TRAITCLASS)
		;
	//PromotionClass
	python::enum_<LeaderClassTypes>("LeaderClassTypes")
		.value("NO_LEADERCLASS", NO_LEADERCLASS)
		;
}
