...
public:
	...
	DllExport int getTurnSliceSinceBeginning() const;																			// Exposed to Python
	void setTurnSliceSinceBeginning(int iNewValue);
...
/*************************************************************************************************/
	int getUPT();																						// Exposed to Python
	DllExport void setUPT(int iNewValue);																// Exposed to Python
	bool isUPTLock();																					// Exposed to Python
	DllExport void setUPTLock(bool bNewValue);															// Exposed to Python
/*************************************************************************************************/
/**	xUPT									END													**/
/*************************************************************************************************/
	...
	DllExport bool isNoCrash() const;
...
/*************************************************************************************************/
	int getSpawnGroupCreatedCount(SpawnGroupTypes eIndex);									// Exposed to Python
	void incrementSpawnGroupCreatedCount(SpawnGroupTypes eIndex);							// Exposed to Python
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
	...
	bool isTriggeredGoody(GoodyTypes eGoody) const;      // Exposed to Python
	void setTriggeredGoody(GoodyTypes eGoody, bool bValue);      // Exposed to Python
...
//FfH: Added by Kael 08/24/2007
	void addPlayerAdvanced(PlayerTypes eNewPlayer, int iNewTeam, LeaderHeadTypes eLeader, CivilizationTypes eCiv, PlayerTypes eSpawnPlayer=NO_PLAYER);   // Exposed to Python
//FfH: End Add
...
/**								----  End Original Code  ----									**/
	bool testVictory(VictoryTypes eVictory, TeamTypes eTeam, bool* pbEndScore = NULL, BuildingClassTypes eIgnoreBuildingClass = NO_BUILDINGCLASS) const;
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	DllExport void addSpellColoredPlot(CvPlot* pPlot, ColorTypes color, int irange);
	DllExport void clearSpellColoredPlot();
...
//FfH: Added by Kael 08/04/2007
	...
	void testVictory();
	int calcTargetBarbs(CvArea* pArea, bool bCountOwnedPlots, PlayerTypes ePlayer) const;
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	void clearProjectTimer(ProjectTypes eProject);
...
/*************************************************************************************************/
	bool isRouteAlwaysAvailable(RouteTypes eRoute) const;
/*************************************************************************************************/
/**	Speedup									END													**/
/*************************************************************************************************/
	...
	void setGlobalFlag(FlagTypes eFlag, bool eChange);
	void setGlobalFlagValue(FlagTypes eFlag, int eChange);
...
protected:
	...
	int m_iTurnSlice;
	int m_iTurnSliceSinceBeginning;
	int m_iCutoffSlice;
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
	int* m_paiSpawnGroupCreatedCount;
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
