...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("getGameTurnAcquired", &CyCity::getGameTurnAcquired, "int ()")
			.def("getCityClass", &CyCity::getCityClass, "int ()")
			.def("setCityClass", &CyCity::setCityClass, "void (int iNewValue)")
			.def("getCityUnits", &CyCity::getCityUnits, "int (int iUnitClass)")
			.def("getCityBuildings", &CyCity::getCityBuildings, "int (int iBuildingClass)")
		...
		.def("changeDefenseModifier", &CyCity::changeDefenseModifier, "void (iChange) - adjust damage value by iChange")
...
/*************************************************************************************************/
		...
		.def("calculateForeignTradeYield", &CyCity::calculateForeignTradeYield, "int (YieldType, int iTradeProfit) - calculates Foreign Trade Yield")
		.def("calculateCityTradeYield", &CyCity::calculateCityTradeYield, "int (YieldType, CyCity, int iTradeProfit) - calculates Trade Yield to the City")
...
/*************************************************************************************************/
		.def("calculateTradeCommerce", &CyCity::calculateTradeCommerce, "int (CommerceType, int iTradeProfit) - Calculates Trade Commerce")
		.def("calculateForeignTradeCommerce", &CyCity::calculateForeignTradeCommerce, "int (CommerceType, int iTradeProfit) - Calculates Foreign Trade Commerce")
		.def("calculateCityTradeCommerce", &CyCity::calculateCityTradeCommerce, "int (CommerceType, CyCity, int iTradeProfit) - Calculates Trade Commerce to the City")
		.def("getTradeCommerce", &CyCity::getTradeCommerce, "int (int /*CommerceTypes*/ eIndex)")
			/*************************************************************************************************/
/**	END																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
		.def("getReligionYield", &CyCity::getReligionYield, "int (int /*YieldTypes*/) - effect on YieldType by Religions")
		.def("getReligionYieldByReligion", &CyCity::getReligionYieldByReligion, "int (int /*YieldTypes*/, ReligionType) - YieldType effect from ReligionType")
/*************************************************************************************************/
/**	Stasis									END													**/
/*************************************************************************************************/
