...
/**		Profiling between (and inside) functions (to see e.g. how much time the EXE takes)		**/
/*************************************************************************************************/
	CySnarkoProfiler* getCyProfiler() const;
/*************************************************************************************************/
/**	SnarkoProfiler							END													**/
/*************************************************************************************************/
	...
	CvPlotEffectInfo* getPlotEffectInfo(int i) const;
...
/*************************************************************************************************/
/**	LeaderRelation		Opera (from poyuzhe)		31.05.09									**/
/*************************************************************************************************/
	CvLeaderRelationInfo* getLeaderRelationInfo(int i) const;
/*************************************************************************************************/
/** End																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	///LorePediaPage
	CvInfoBase* getLoreInfo(int i) const;
...
//FlavoruMod: Added by Jean Elcard (ClimateSystem)
	CvClimateZoneInfo* getClimateZoneInfo(int i) const;
...
/*************************************************************************************************/
	CvInfoBase* getFeatInfo(int i) const;
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
//FfH Spell System: Added by Kael 07/23/2007
	...
	int getNumAffinityInfos() const { return GC.getNumAffinityInfos(); }
	...
	int getNumLoreInfos() const { return GC.getNumLoreInfos(); }
...
/*************************************************************************************************/
	int getNumLeaderRelationInfos() const { return GC.getNumLeaderRelationInfos(); }
/*************************************************************************************************/
/** End																								**/
/*************************************************************************************************/
...
//FlavoruMod: Added by Jean Elcard (ClimateSystem)
	int getNumClimateZoneInfos() const { return GC.getNumClimateZoneInfos(); }
...
/*************************************************************************************************/
	...
	int getDEMON_PLAYER() const		{ return GC.getDEMON_PLAYER(); }
	int getDEMON_TEAM() const		{ return GC.getDEMON_TEAM(); }
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
	...
	int getNumLeaderClassInfos() const { return GC.getNumLeaderClassInfos(); }
	CvLeaderClassInfo* getLeaderClassInfo(int i) const;
