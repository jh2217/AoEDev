...
void CyGlobalContextPythonInterface3(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getNumLoreInfos", &CyGlobalContext::getNumLoreInfos, "int () - NumConceptInfos")
		.def("getLoreInfo", &CyGlobalContext::getLoreInfo, python::return_value_policy<python::reference_existing_object>(), "Concept Info () - Returns info object")
