...
/**																								**/
/**							New includes are required to do the Pop-up							**/
/*************************************************************************************************/
...
/**																								**/
/**					Not sure why this one is different from the other three						**/
/*************************************************************************************************/
/**								---- Start Original Code ----									**
...
/*************************************************************************************************/
/**	EasyBreezy								01/16/09								Xienwolf	**/
/**																								**/
/**					Prevents selection of conflicting/overridding Victory Conditions			**/
/*************************************************************************************************/
		if (bVictory)
		{
			if (GC.getVictoryInfo(eVictoryID).getNumLinkedVictories() > 0)
			{
				for (int iI=0;iI<GC.getVictoryInfo(eVictoryID).getNumLinkedVictories();iI++)
				{
					setVictory((VictoryTypes)GC.getVictoryInfo(eVictoryID).getLinkedVictory(iI), false);
				}
			}
		}
/*************************************************************************************************/
...
/**	CivSelector							10/22/08									Xienwolf	**/
/**																								**/
/**				Launches the Pop-up to select which Civilizations to cut from Random			**/
/*************************************************************************************************/
		if (eIndex == GAMEOPTION_LIMITED_CIVILIZATION_SELECTION && getType() == GAME_SP_NEW)
		{
			if (bOption)
			{
				gDLL->getPythonIFace()->callFunction("CvScreensInterface", "showCivSelectScreen");
			}
		}
...
/*************************************************************************************************/
		if (eID == ORC_PLAYER && eCiv == (CivilizationTypes)(GC.getDefineINT("ORC_CIVILIZATION")))
		{
			setCiv(ANIMAL_PLAYER, (CivilizationTypes)(GC.getDefineINT("ANIMAL_CIVILIZATION")));
			setCiv(DEMON_PLAYER, (CivilizationTypes)(GC.getDefineINT("DEMON_CIVILIZATION")));
		}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
...
/**				Workaround required until source of this call for Barbarians is located			**/
/*************************************************************************************************/
		if (eID == ORC_PLAYER && eLeader == (LeaderHeadTypes)(GC.getDefineINT("ORC_LEADER")))
		{
			setLeader(ANIMAL_PLAYER, (LeaderHeadTypes)(GC.getDefineINT("ANIMAL_LEADER")));
			setLeader(DEMON_PLAYER, (LeaderHeadTypes)(GC.getDefineINT("DEMON_LEADER")));
		}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
...
/**				Workaround required until source of this call for Barbarians is located			**/
/*************************************************************************************************/
	if (eID == ORC_PLAYER && eTeam == ORC_TEAM)
	{
		setTeam(ANIMAL_PLAYER, ANIMAL_TEAM);
		setTeam(DEMON_PLAYER, DEMON_TEAM);
	}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	if (eID == ORC_PLAYER)
	{
		setHandicap(ANIMAL_PLAYER, eHandicap);
		setHandicap(DEMON_PLAYER, eHandicap);
	}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
...
/**				Workaround required until source of this call for Barbarians is located			**/
/*************************************************************************************************/
	if (eID == ORC_PLAYER && eColor != -1 && eColor == GC.getCivilizationInfo(GET_PLAYER(ORC_PLAYER).getCivilizationType()).getDefaultPlayerColor())
	{
		...
		setColor(DEMON_PLAYER, (PlayerColorTypes)GC.getCivilizationInfo(GET_PLAYER(DEMON_PLAYER).getCivilizationType()).getDefaultPlayerColor());
	}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
...
/**				Workaround required until source of this call for Barbarians is located			**/
/*************************************************************************************************/
		if (eID == ORC_PLAYER && eSlotStatus == SS_COMPUTER)
		{
			setSlotStatus(ANIMAL_PLAYER, SS_COMPUTER);
			setSlotStatus(DEMON_PLAYER, SS_COMPUTER);
		}
/*************************************************************************************************/
/**	MultiBarb								END													**/
/*************************************************************************************************/
