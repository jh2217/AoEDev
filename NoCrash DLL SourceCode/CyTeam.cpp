...
/*************************************************************************************************/
int CyTeam::getBlockBonuses()
	{return m_pTeam ? m_pTeam->getBlockBonuses() : 0;}

int CyTeam::getRevealAllBonuses()
	{return m_pTeam ? m_pTeam->getRevealAllBonuses() : 0;}

int CyTeam::getHideUnits()
	{return m_pTeam ? m_pTeam->getHideUnits() : 0;}

int CyTeam::getSeeInvisible()
	{return m_pTeam ? m_pTeam->getSeeInvisible() : 0;}

int CyTeam::getProjectTimer(ProjectTypes eProject, int iCount)
	{return m_pTeam ? m_pTeam->getProjectTimer(eProject, iCount) : -1;}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
