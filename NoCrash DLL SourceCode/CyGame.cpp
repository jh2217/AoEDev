...
/*************************************************************************************************/
int CyGame::getUPT() const
{
	return (NULL != m_pGame ? m_pGame->getUPT() : 0);
}

void CyGame::setUPT(int iNewValue)
{
	if (m_pGame)
		m_pGame->setUPT(iNewValue);
}

bool CyGame::isUPTLock() const
{
	return (NULL != m_pGame ? m_pGame->isUPTLock() : false);
}

void CyGame::setUPTLock(bool bNewValue)
{
	if (m_pGame)
		m_pGame->setUPTLock(bNewValue);
}
/*************************************************************************************************/
/**	xUPT									END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
int CyGame::getSpawnGroupCreatedCount(int /*SpawnGroupTypes*/ eIndex)
{
	return m_pGame ? m_pGame->getSpawnGroupCreatedCount((SpawnGroupTypes)eIndex) : -1;
}
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
...
void CyGame::addPlayerAdvanced(int eNewPlayer, int iNewTeam, int eLeader, int eCiv, int eSpawnPlayer)
{
	if (m_pGame)
	{
		m_pGame->addPlayerAdvanced((PlayerTypes)eNewPlayer, iNewTeam, (LeaderHeadTypes)eLeader, (CivilizationTypes)eCiv, (PlayerTypes)eSpawnPlayer);
	}
}
//FfH: End Add
...
/*************************************************************************************************/
int CyGame::getTrueGlobalCounter() const									{return (NULL != m_pGame ? m_pGame->getTrueGlobalCounter() : -1);}
int CyGame::getProjectTimer(ProjectTypes eProject, int iCount)				{return (NULL != m_pGame ? m_pGame->getProjectTimer(eProject, iCount) : -1);}
void CyGame::decrementUnitClassCreatedCount(int eUnitClassType)				{if (m_pGame) m_pGame->decrementUnitClassCreatedCount((UnitClassTypes)eUnitClassType);}
int CyGame::getNumCivActive(int eCivilization)								{return (NULL != m_pGame ? m_pGame->getNumCivActive((CivilizationTypes)eCivilization) : 0);}
int CyGame::getCivActivePlayer(int eCivilization, int iCount)				{return (NULL != m_pGame ? m_pGame->getCivActivePlayer((CivilizationTypes)eCivilization, iCount) : -1);}
bool CyGame::isEventTriggered(int eTrigger) const							{return (NULL != m_pGame ? m_pGame->isEventTriggered((EventTriggerTypes)eTrigger) : false);}
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
void CyGame::incrementSpawnGroupCreatedCount(int /*SpawnGroupTypes*/ eIndex)
{
	if (m_pGame)
	{
		m_pGame->incrementSpawnGroupCreatedCount((SpawnGroupTypes)eIndex);
	}
}
/*************************************************************************************************/
/**	Spawn Groups							END													**/
...
//FfH: End Add
///FlagSystem
void CyGame::setGlobalFlag(int eFlag, bool bChange) {
	if (m_pGame)
		return	m_pGame->setGlobalFlag((FlagTypes)eFlag, bChange);
	return;
}
void CyGame::setGlobalFlagValue(int eFlag, int bChange) {
	if (m_pGame)
		return	m_pGame->setGlobalFlagValue((FlagTypes)eFlag, bChange);
	return;
}
void CyGame::changeGlobalFlagValue(int eFlag, int bChange) {
	if (m_pGame)
		return	m_pGame->changeGlobalFlagValue((FlagTypes)eFlag, bChange);
	return;
}

bool CyGame::isUniDay()
{
	return (NULL != m_pGame ? m_pGame->isUniDay() : false);
}