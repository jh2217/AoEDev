...
#include "CyTeam.h"
/*************************************************************************************************/
/**	SnarkoProfiler								03/02/12						Snarko			**/
...
/**		Profiling between (and inside) functions (to see e.g. how much time the EXE takes)		**/
/*************************************************************************************************/
		.def("getProfiler", &CyGlobalContext::getCyProfiler, python::return_value_policy<python::reference_existing_object>(), "() - CyProfiler()")
/*************************************************************************************************/
/**	SnarkoProfiler							END													**/
/*************************************************************************************************/
		...
		.def("isNoCrash", &CyGlobalContext::isCyNoCrash, "bool () - NoCrashDLl Flag")
		...
		.def("getNumPlotEffectInfos", &CyGlobalContext::getNumPlotEffectInfos, "() - Total PlotEffect Infos XML\\Terrain\\CIV4PlotEffectInfos.xml")
		.def("getPlotEffectInfo", &CyGlobalContext::getPlotEffectInfo, python::return_value_policy<python::reference_existing_object>(), "(PlotEffectID) - CvInfo for PlotEffectID")
		...
		.def("getNumLeaderClassInfos", &CyGlobalContext::getNumLeaderClassInfos, "() - Total LeaderHead Infos XML\\Civilizations\\CIV4LeaderHeadInfos.xml")
		.def("getLeaderClassInfo", &CyGlobalContext::getLeaderClassInfo, python::return_value_policy<python::reference_existing_object>(), "(LeaderHeadID) - CvInfo for LeaderHeadID")
