...
/**																								**/
/**									Declares a new global class.								**/
/*************************************************************************************************/
class CvStateNameInfo;
/*************************************************************************************************/
/**	StateNames								END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
/*************************************************************************************************/
/**	SnarkoProfiler								30/04/10						Snarko			**/
...
//FlavourMod: Addded by Jean Elcard 11/09/2009 (ClimateSystem)
	int getNumTerrainClassInfos();
	std::vector<CvTerrainClassInfo*>& getTerrainClassInfo();
	CvTerrainClassInfo& getTerrainClassInfo(TerrainClassTypes eTerrainClassNum);
//FlavourMod: End Add
	...
	int getNumLoreInfos();
	std::vector<CvInfoBase*>& getLoreInfo();
	CvInfoBase& getLoreInfo(LoreTypes e);
...
/*************************************************************************************************/
	DllExport int getNumAlignmentInfos();
/*************************************************************************************************/
/** AlignmentAttitudeModifier                   END                                             **/
/*************************************************************************************************/
	std::vector<CvInfoBase*>& getAlignmentInfo();
	CvInfoBase& getAlignmentInfo(AlignmentTypes eAlignmentNum);
...
/*************************************************************************************************/
	DllExport int getNumEthicalAlignmentInfos();
	std::vector<CvInfoBase*>& getEthicalAlignmentInfo();
	CvInfoBase& getEthicalAlignmentInfo(EthicalAlignmentTypes eEthicalAlignmentNum);
/*************************************************************************************************/
...
/*************************************************************************************************/
	int getNumLeaderStatusInfos();
	std::vector<CvInfoBase*>& getLeaderStatusInfo();
	CvInfoBase& getLeaderStatusInfo(LeaderStatusTypes eLeaderStatusNum);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
	...
	CvInfoBase& getDamageTypeInfo(DamageTypes eDamageNum);

	int getNumSpellInfos();
	std::vector<CvSpellInfo*>& getSpellInfo();
	CvSpellInfo& getSpellInfo(SpellTypes eSpellNum);
//FfH: End Add
/*************************************************************************************************/
...
/*************************************************************************************************/
	int getNumFeatInfos();
	std::vector<CvInfoBase*>& getFeatInfo();
	CvInfoBase& getFeatInfo(FeatTypes eFeatNum);
	int getMaxNumProjectsAllowed();

	int getNumStateNameInfos();
	std::vector<CvStateNameInfo*>& getStateNameInfo();
	CvStateNameInfo& getStateNameInfo(StateNameTypes eStateNameNum);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
	int getNumSpawnGroupInfos();
	std::vector<CvSpawnGroupInfo*>& getSpawnGroupInfo();
	CvSpawnGroupInfo& getSpawnGroupInfo(SpawnGroupTypes eSpawnGroupNum);
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					Vastly improved Affinity system, open to many tags							**/
/*************************************************************************************************/
	int getNumAffinityInfos();
	std::vector<CvAffinityInfo*>& getAffinityInfo();
	CvAffinityInfo& getAffinityInfo(AffinityTypes eAffinity);
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
	int getNumTechInfos();
...
//FlavourMod: Addded by Jean Elcard 11/11/2009 (ClimateSystem)
	int getNumClimateZoneInfos();
	std::vector<CvClimateZoneInfo*>& getClimateZoneInfo();
	CvClimateZoneInfo& getClimateZoneInfo(ClimateZoneTypes eClimateZoneNum);
//FlavourMod: End Add
/*************************************************************************************************/
/** LeaderRelations		Opera (from poyuzhe)    31.05.09        imported by Valkrionn	09.26.09**/
/*************************************************************************************************/
	int getNumLeaderRelationInfos();
	std::vector<CvLeaderRelationInfo*>& getLeaderRelationInfo();
	CvLeaderRelationInfo& getLeaderRelationInfo(LeaderRelationTypes eLeaderRelationNum);
/*************************************************************************************************/
/** End																							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int& getNumGoodyClassTypes();
	CvString*& getGoodyClassTypes();
	CvString& getGoodyClassTypes(GoodyClassTypes e);
	CvString*& getTraitHookTypes();
	CvString& getTraitHookTypes(TraitHookTypes e);
	CvString*& getTradeableItems();
	CvString& getTradeableItems(TradeableItems e);
...
/*************************************************************************************************/
	int& getNumCivFlavorTypes();
	CvString*& getCivFlavorTypes();
	CvString& getCivFlavorTypes(CivFlavorTypes e);
/*************************************************************************************************/
...
/*************************************************************************************************/
	int& getNumAIVictoryTypes();
	CvString*& getAIVictoryTypes();
	CvString& getAIVictoryTypes(AIVictoryWeightTypes e);
/*************************************************************************************************/
/**	Improved AI								END													**/
/*************************************************************************************************/
	...
	// FlagSystem Start
	int getNumFlagInfos();
	std::vector<CvFlagInfo*>& getFlagInfo();
	CvFlagInfo& getFlagInfo(FlagTypes eFlag);

	// ModuleId Start
	int getNumModuleIdInfos();
	std::vector<CvModuleIdInfo*>& getModuleIdInfo();
	CvModuleIdInfo& getModuleIdInfo(ModuleIds eFlag);

	// PlotEffect Start
	int getNumPlotEffectInfos();
	std::vector<CvPlotEffectInfo*>& getPlotEffectInfo();
	CvPlotEffectInfo& getPlotEffectInfo(PlotEffectTypes eFlag);
	...
	std::vector<CvPromotionClassInfo*>& getPromotionClassInfo();
	CvPromotionClassInfo& getPromotionClassInfo(PromotionClassTypes ePromotionClass);

	//CityClass
	int getNumCityClassInfos();
	std::vector<CvCityClassInfo*>& getCityClassInfo();
	CvCityClassInfo& getCityClassInfo(CityClassTypes eCityClass);

	//TraitClass
	int getNumTraitClassInfos();
	std::vector<CvTraitClassInfo*>& getTraitClassInfo();
	CvTraitClassInfo& getTraitClassInfo(TraitClassTypes eTraitClass);
	//LeaderClass
	int getNumLeaderClassInfos();
	std::vector<CvLeaderClassInfo*>& getLeaderClassInfo();
	CvLeaderClassInfo& getLeaderClassInfo(LeaderClassTypes eLeaderClass);
	//TraitTrigger
	int getNumTraitTriggerInfos();
	std::vector<CvTraitTriggerInfo*>& getTraitTriggerInfo();
	CvTraitTriggerInfo& getTraitTriggerInfo(TraitTriggerTypes eTraitTrigger);

	int getCRIME_RATE_PER_POP();
...
/*************************************************************************************************/
	...
	//Magic Rework
	inline int getMAGICAL_POWER_PER_DOMINION() { return m_iMAGICAL_POWER_PER_DOMINION; }
...
/*************************************************************************************************/
	int getUSE_CANNOT_DO_RELIGION_CALLBACK();
...
/**								Defines Function for Use in .cpp								**/
/*************************************************************************************************/
	int getUSE_UNIT_STATISTICS_CALLBACK();
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	int getUSE_UPGRADE_PRICE_CALLBACK();
/*************************************************************************************************/
/**	Speedup									END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
//FfH: Added by Kael 07/23/2007
	bool readSpellInfoArray(FDataStreamBase* pStream);
	void writeSpellInfoArray(FDataStreamBase* pStream);
//FfH: End Add
...
/**		Profiling between (and inside) functions (to see e.g. how much time the EXE takes)		**/
/*************************************************************************************************/
	CvSnarkoProfiler* m_snarkoProfiler;
/*************************************************************************************************/
/**	SnarkoProfiler							END													**/
/*************************************************************************************************/
...
//FlavourMod: End Add
	...
	///LorePediaPage
	std::vector<CvInfoBase*> m_paLoreInfo;
...
/**							Adds a new alignment axis to the game								**/
/*************************************************************************************************/
	std::vector<CvInfoBase*> m_paEthicalAlignmentInfo;
/*************************************************************************************************/
/**	Lawful-Chaotic Alignments					END												**/
/*************************************************************************************************/
/*************************************************************************************************/
/**	LeaderStatus Infos      				10/01/09								Valkrionn	**/
/*************************************************************************************************/
	std::vector<CvInfoBase*> m_paLeaderStatusInfo;
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/**	StateNames								12/12/08								Jean Elcard	**/
/**																								**/
/**									Globals to load from XML.									**/
/*************************************************************************************************/
	std::vector<CvStateNameInfo*> m_paStateNameInfo;
/*************************************************************************************************/
/**	StateNames								END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
	std::vector<CvSpawnGroupInfo*> m_paSpawnGroupInfo;
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					Vastly improved Affinity system, open to many tags							**/
/*************************************************************************************************/
	std::vector<CvAffinityInfo*> m_paAffinityInfo;
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
...
//FlavourMod: Addded by Jean Elcard 11/11/2009 (ClimateSystem)
	std::vector<CvClimateZoneInfo*> m_paClimateZoneInfo;
//FlavourMod: End Add

/*************************************************************************************************/
/** LeaderRelations		Opera (from poyuzhe)    31.05.09        imported by Valkrionn	09.26.09**/
/*************************************************************************************************/
	std::vector<CvLeaderRelationInfo*> m_paLeaderRelationInfo;
/*************************************************************************************************/
/** End																							**/
/*************************************************************************************************/
	...
	CvString* m_paszTradeableItems;

	CvString* m_paszTraitHookTypes;
...
/**							Moving explore lair results into SDK								**/
/*************************************************************************************************/
	CvString *m_paszGoodyClassTypes;
	int m_iNumGoodyClassTypes;
/*************************************************************************************************/
/**	MISSION_EXPLORE_LAIR					END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**			for helping AI with things we can't really add in a non-hardcoded way				**/
/*************************************************************************************************/
	CvString *m_paszCivFlavorTypes;
	int m_iNumCivFlavorTypes;
/*************************************************************************************************/
/**	Civilization Flavors					END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**							Teaching the AI to go for victories.								**/
/*************************************************************************************************/
	CvString *m_paszAIVictoryTypes;
	int m_iNumAIVictoryTypes;
/*************************************************************************************************/
/**	Improved AI								END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	//Magic Rework
	int m_iMAGICAL_POWER_PER_DOMINION;
	//Crime
	int m_iCRIME_RATE_PER_POP;
...
/** CanDoReligion						  Valkrionn								12/11/09        **/
/*************************************************************************************************/
	int m_iUSE_CANNOT_DO_RELIGION_CALLBACK;
...
/**	This function is called a lot of times late game, so don't call python unless needed.		**/
/*************************************************************************************************/
	int m_iUSE_UPGRADE_PRICE_CALLBACK;
/*************************************************************************************************/
/**	Speedup									END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/************************************************************************************************/
	// FlagSystem Start
	std::vector<CvFlagInfo*> m_paFlagInfo;
	// ModuleId Start
	std::vector<CvModuleIdInfo*> m_paModuleIdInfo;
	// PlotEffect Start
	...
	//CityClass
	std::vector<CvCityClassInfo*> m_paCityClassInfo;

	//DynTrait
	std::vector<CvTraitClassInfo*> m_paTraitClassInfo;
	std::vector<CvLeaderClassInfo*> m_paLeaderClassInfo;
	std::vector<CvTraitTriggerInfo*> m_paTraitTriggerInfo;
};
