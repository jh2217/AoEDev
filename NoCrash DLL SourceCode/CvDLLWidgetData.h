...
/*************************************************************************************************/
	void parseSlaveListHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void doSlaveList(CvWidgetDataStruct &widgetDataStruct);
	void parseMasterUnitHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void doMasterUnit(CvWidgetDataStruct &widgetDataStruct);
	void parseMinionListHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void doMinionList(CvWidgetDataStruct &widgetDataStruct);
	void parseCommanderUnitHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void doCommanderUnit(CvWidgetDataStruct &widgetDataStruct);
	void doRestrictCiv(CvWidgetDataStruct &widgetDataStruct);
	void parseArmageddonCounterHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	void parseCityActionHelp(int iSpell, CvWStringBuffer &szBuffer);
	void doCityAction(int iSpell);
/*************************************************************************************************/
/**	City Actions							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
	void doPediaSpawnGroupJump(CvWidgetDataStruct &widgetDataStruct);
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/*************************************************************************************************/
	void doPediaAffinityJump(CvWidgetDataStruct &widgetDataStruct);
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
	...
	void parseCrimeHelp(CvWidgetDataStruct& widgetDataStruct, CvWStringBuffer& szBuffer);
...
//	void parsePopupQueue(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	...
	void parseBuildingHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer, bool bCivilopedia=false,bool bInGame=true);
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
	void parseSpawnGroupHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
/**					Vastly improved Affinity system, open to many tags							**/
/*************************************************************************************************/
	void parseAffinityHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
