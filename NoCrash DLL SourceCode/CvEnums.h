...
{
	CAMERALOOKAT_NORMAL,
	CAMERALOOKAT_CITY_ZOOM_IN, // TODO Ronkhar : check if this can be used to modify the zoom for city view (could be adapted to dezoom civs with radius 3, or city with wonder radius 3)
	CAMERALOOKAT_BATTLE,
...
enum AreaBorderLayers
{
	...
	AREA_BORDER_LAYER_TARGETED_SPELL,
	AREA_BORDER_LAYER_TARGETED_SPELL_HIGHLIGHT,
...
/**																								**/
/**								Adds New Widgets to the Game									**/
/*************************************************************************************************/
	WIDGET_SLAVE_LIST,
	WIDGET_MASTER_UNIT,
	WIDGET_MINION_LIST,
	WIDGET_COMMANDER_UNIT,
	WIDGET_ARMAGEDDON_COUNTER,
	WIDGET_RESTRICT_CIV,
	WIDGET_HELP_CIVIC,
...
/*************************************************************************************************/
	WIDGET_PEDIA_JUMP_TO_SPAWNGROUP,
/*************************************************************************************************/
/**	Spawn Groups							END													**/
/*************************************************************************************************/
/*************************************************************************************************/
...
//FfH: Added by Kael 11/04/2007
	...
	BUTTONPOPUP_GOBLINCITYCLASS,
	BUTTONPOPUP_TRAITCHOICE,
//FfH: End Add
...
/*************************************************************************************************/
enum CivFlavorTypes						// Exposed to Python
{
	NO_CIVFLAVOR = -1,
	CIVFLAVOR_SAVE_GOLD,
	CIVFLAVOR_HIGH_FOOD,
	CIVFLAVOR_HIGH_HAMMER,
	CIVFLAVOR_HIGH_COMMERCE,
	CIVFLAVOR_HIGH_POPULATION,
	CIVFLAVOR_TRADEROUTES,
	CIVFLAVOR_GLOBALCOUNTER,
...
enum GameOptionTypes				// Exposed to Python
{
	...
	GAMEOPTION_ADVANCED_START, //Hardcoded to be 0
...
//	GAMEOPTION_NO_ESPIONAGE,
	GAMEOPTION_RAGING_BARBARIANS,
	GAMEOPTION_NO_VISIBLE_BARBARIANS,
	GAMEOPTION_AGGRESSIVE_AI,
	GAMEOPTION_ONE_CITY_CHALLENGE,
	GAMEOPTION_BARBARIAN_WORLD,
	GAMEOPTION_NO_SETTLERS,
	GAMEOPTION_LEAD_ANY_CIV, // Hardcoded to be 7
...
//FF: Added by Valkrionn
	GAMEOPTION_TIMID_ANIMALS,
...
//FF: Added by Valkrionn
	...
	GAMEOPTION_FERAL_MANA,
	GAMEOPTION_MANA_GUARDIANS,
	GAMEOPTION_NO_LIBERATION,
...
//FfH: End Modify
/**								----  End Original Code  ----									**/
	GAMEOPTION_RELIGIOUS_HUD,
	GAMEOPTION_BROADER_ALIGNMENTS,
	GAMEOPTION_FLAVOUR_START,
	GAMEOPTION_NO_WORKER_XP,
...
/*************************************************************************************************/
/** Those options are used to filter random leaders                                             **/
/*************************************************************************************************/
	GAMEOPTION_THE_ACKNOWLEDGEMENT,
	GAMEOPTION_WELLKNOWN_FACES,
/*************************************************************************************************/
/** End                                                                                         **/
/*************************************************************************************************/
	GAMEOPTION_NO_INFLATION,
	GAMEOPTION_DARK_FORESTS,
	GAMEOPTION_DELAYED_LAIRS,
	GAMEOPTION_NO_AUTOCAST,
	GAMEOPTION_NO_NATIONAL_LIMIT,
	...
	GAMEOPTION_ALWAYS_OPEN_BORDERS,
	GAMEOPTION_ALWAYS_RAZE,
	GAMEOPTION_LIMITED_CIVILIZATION_SELECTION,
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
/**								Adds new Game Options											**/
/*************************************************************************************************/
	MPOPTION_RANDOM_LOGGER,
	MPOPTION_ENABLE_AUTOPLAY,
/*************************************************************************************************/
/**	New Tag Defs							END													**/
/*************************************************************************************************/
...
enum PlayerOptionTypes			// Exposed to Python
{
	...
	PLAYEROPTION_EVENTS_SHOW_BLOCKED_ANSWERS,
...
/*************************************************************************************************/
enum GoodyClassTypes						// Exposed to Python
{
	NO_GOODYCLASS = -1,
};
/*************************************************************************************************/
...
enum LoreTypes				// Exposed to Python
{
	NO_LORE = -1,
};
...
/*************************************************************************************************/
enum EthicalAlignmentTypes
{
	NO_ETHICAL_ALIGNMENT = -1,

	ETHICAL_ALIGNMENT_LAWFUL,
	ETHICAL_ALIGNMENT_NEUTRAL,
	ETHICAL_ALIGNMENT_CHAOTIC,

#ifdef _USRDLL
	NUM_ETHICAL_ALIGNMENT_TYPES
#endif
};
/*************************************************************************************************/
...
/**											07/03/09 (Republic)						Vehem		**/
/**									Adds new Feats												**/
/*************************************************************************************************/
	FEAT_VISIT_POOL_OF_TEARS,
	FEAT_VISIT_SIRONAS_BEACON,
	FEAT_VISIT_MIRROR_OF_HEAVEN,
	FEAT_VISIT_REMNANTS_OF_PATRIA,
	FEAT_VISIT_ODIOS_PRISON,
	FEAT_VISIT_BRADELINES_WELL,
/*************************************************************************************************/
/** Adding more UFs					Opera														**/
/*************************************************************************************************/
	FEAT_VISIT_AIFON_ISLE,
	FEAT_VISIT_BAIR_OF_LACUNA,
	FEAT_VISIT_BROKEN_SEPULCHER,
	FEAT_VISIT_CLIFFS_OF_KELLE,
	FEAT_VISIT_FOXFORD,
	FEAT_VISIT_GUARDIAN_PRISTIN_PASS,
	FEAT_VISIT_LETUM_FRIGUS,
	FEAT_VISIT_MAELSTROM,
	FEAT_VISIT_MOUNT_KALSHEKK,
	FEAT_VISIT_PYRE_OF_THE_SERAPHIC,
	FEAT_VISIT_RING_OF_CARCER,
	FEAT_VISIT_RINWELL_ISLE,
	FEAT_VISIT_SEVEN_PINES,
	FEAT_VISIT_STANDING_STONES,
	FEAT_VISIT_TOMB_OF_SUCELLUS,
	FEAT_VISIT_TOWER_OF_EYES,
	FEAT_VISIT_YGGDRASIL,
/*************************************************************************************************/
/** Adding more UFs					END															**/
/*************************************************************************************************/
	FEAT_BUILT_KEEP,
...
/**																								**/
/**							Defines a new enum type for State Names								**/
/*************************************************************************************************/
enum StateNameTypes
{
	NO_STATENAME = -1
...
/**					New spawn mechanic, allowing us to customize stacks							**/
/*************************************************************************************************/
enum SpawnGroupTypes				// Exposed to Python
{
	NO_SPAWNGROUP = -1,
};
/*************************************************************************************************/
...
/**					Vastly improved Affinity system, open to many tags							**/
/*************************************************************************************************/
enum AffinityTypes					// Exposed to Python
{
	NO_AFFINITY = -1,
};
/*************************************************************************************************/
...
/*************************************************************************************************/
	...
	CIVILOPEDIA_PAGE_AFFINITY,
	CIVILOPEDIA_PAGE_LORE,
/*************************************************************************************************/
/**	Better Affinity							END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
/**	LeaderRelations		Opera 28.05.09        imported by Valkrionn	09.26.09                    **/
/*************************************************************************************************/
/*************************************************************************************************/
enum LeaderRelationTypes	// Exposed to Python
{
	NO_LEADERRELATION = -1,
};
/*************************************************************************************************/
...
/*************************************************************************************************/
// any additions need to be reflected in GlobalTypes.xml
enum AIVictoryWeightTypes
{
	NO_AIVICTORY = -1,

	AI_VICTORY_WEIGHT_PROJECT,
	AI_VICTORY_WEIGHT_CONQUEST,
	AI_VICTORY_WEIGHT_DOMINATION,
	AI_VICTORY_WEIGHT_CULTURE,
	AI_VICTORY_WEIGHT_DIPLOMACY,
	AI_VICTORY_WEIGHT_RELIGION,
	AI_VICTORY_WEIGHT_GP_BUILDING,
	AI_VICTORY_WEIGHT_BONUS_BUILDING,
#ifdef _USRDLL
	NUM_AI_VICTORY_WEIGHT,
#endif
};
/*************************************************************************************************/
/**	Improved AI								END													**/
/*************************************************************************************************/
// FlagSystem Start
enum FlagTypes		// Exposed to Python
{
	NO_FLAG = -1,
};

//ModuleIds
enum ModuleIds		// Exposed to Python
{
	NO_MODULE = -1,
};
//PlotEffect
enum PlotEffectTypes		// Exposed to Python
{
	NO_PLOT_EFFECT = -1,
};

//Magic Rework
enum SpellClassTypes		// Exposed to Python
{
	NO_SPELLCLASS = -1,
};
...
//CityClass
enum CityClassTypes		// Exposed to Python
{
	NO_CITYCLASS = -1,
};

//DynTraits
enum TraitClassTypes		// Exposed to Python
{
	NO_TRAITCLASS = -1,
};
enum LeaderClassTypes		// Exposed to Python
{
	NO_LEADERCLASS = -1,
};

enum TraitTriggerTypes		// Exposed to Python
{
	NO_TRAITTRIGGER = -1,
};
...
{
	NO_TRAITHOOK = -1,
	TRAITHOOK_PLAYER_TURN,
	TRAITHOOK_START_WAR,
	TRAITHOOK_MAKE_PEACE,
	TRAITHOOK_MAKE_VASSAL,
	TRAITHOOK_LOSE_VASSAL,
	TRAITHOOK_BECOME_VASSAL,
	TRAITHOOK_FREED_VASSAL,
	TRAITHOOK_CITY_FOUND,
	TRAITHOOK_CITY_RAZE,
	TRAITHOOK_CITY_ACQUIRE,
	TRAITHOOK_CITY_HURRY,
	TRAITHOOK_CITY_POPGROW,
	TRAITHOOK_CITY_CULTUREGROW,
	TRAITHOOK_CHANGE_RELIGION,
	TRAITHOOK_TRADE,
	TRAITHOOK_BUILD_ROUTE,
	TRAITHOOK_BUILD_IMPROVEMENT,
	TRAITHOOK_IMPROVE_IMPROVEMENT,
	TRAITHOOK_CONNECT_RESOURCE,
	TRAITHOOK_CREATE_PROJECT,
	TRAITHOOK_CONSTRUCT_BUILDING,
	TRAITHOOK_TRAIN_UNIT,
	TRAITHOOK_UPGRADE_UNIT,
	TRAITHOOK_GP_BORN,
	TRAITHOOK_GP_SETTLE,
	TRAITHOOK_KILL_UNIT,
	TRAITHOOK_UNIT_SPREAD_RELIGION,
	TRAITHOOK_PILLAGE,
	TRAITHOOK_GOODY,
	TRAITHOOK_CAST_SPELL,
	TRAITHOOK_UNIT_LEVEL_UP,
	TRAITHOOK_UNIT_GAIN_PROMOTION,
	TRAITHOOK_UNIT_LOSE_PROMOTION,
	TRAITHOOK_GAIN_ALIGNMENT,
	TRAITHOOK_LOSE_ALIGNMENT,
	TRAITHOOK_GAIN_ETHICAL_ALIGNMENT,
	TRAITHOOK_LOSE_ETHICAL_ALIGNMENT,
	TRAITHOOK_GAIN_ALIGNMENT_POINTS,
	TRAITHOOK_LOSE_ALIGNMENT_POINTS,
	TRAITHOOK_GAIN_ETHICAL_ALIGNMENT_POINTS,
	TRAITHOOK_LOSE_ETHICAL_ALIGNMENT_POINTS,
	TRAITHOOK_GAIN_PLOT_OWNERSHIP,
	TRAITHOOK_LOSE_PLOT_OWNERSHIP,
	TRAITHOOK_CONVERT_CITY,
	TRAITHOOK_EXPLORE_LAIR,
	TRAITHOOK_CAPTURE_UNIT,
	TRAITHOOK_CONVERT_CITY_RELIGIOUS_LEADER,
	TRAITHOOK_UNIT_KILLED,
	TRAITHOOK_TECH,
	TRAITHOOK_IMPROVEMENT_PILLAGED,
	TRAITHOOK_GAIN_IMPROVEMENT,
	TRAITHOOK_LOSE_IMPROVEMENT,
	NUM_TRAITHOOK_TYPES
};
