...
/*************************************************************************************************/
/**								---- Start Original Code ----									**
int cyFinalImprovementUpgrade(int eImprovement, int iCount)
{
...
{
	return finalImprovementUpgrade((ImprovementTypes) eImprovement, NO_CIVILIZATION, iCount);
}

int /*ImprovementTypes*/ cyFinalImprovementUpgradeCiv(int /*ImprovementTypes*/ eImprovement, int /*CivilizationTypes*/ eCivilization, int iCount)
{
	return finalImprovementUpgrade((ImprovementTypes) eImprovement, (CivilizationTypes) eCivilization, iCount);
}
/*************************************************************************************************/
/**	MyLand									END													**/
/*************************************************************************************************/
...
/*************************************************************************************************/
bool cyIsCountCitiesAsUnitClass(int /*UnitClassTypes*/ eUnitClass)
{
	return isCountCitiesAsUnitClass((UnitClassTypes)eUnitClass);
}
/*************************************************************************************************/
/**	WeightedCost								END												**/
/*************************************************************************************************/
